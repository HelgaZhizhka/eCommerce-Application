...
- _Tailwind + shadcn/ui_ — «новый стек» в полном смысле: одна система стилей,
...
- _MUI 7_ — сохранение визуала с меньшими затратами: миграция 5→7 по
...
- Текущий деплой — Netlify, проект — SPA. _Vite + Netlify Functions_ (только
  для auth-proxy) — минимальное изменение модели, рекомендую как базовый
  вариант.
- _Next.js (App Router, RSC)_ оправдан, если нужны SEO/SSR для каталога
